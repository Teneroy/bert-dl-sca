...
bert_model = BERTModel(num_classes)  # Assuming num_classes is defined as 256
bert_model.load_state_dict(torch.load(trained_model_path))
...
wandb.init(
    ...
    project="bert-thesis-sca-test-ranked",
    name=run_name,
...
test_model(bert_model, X_test, metadata_plaintext, metadata_key, num_test_traces)